...
const newsUpdates = [
  {
    ...
    link: "https://utkarsh.com/current-affairs/national/government-scheme/pm-modi-released-the-15th-installment-of-pm-kisan-yojana-from-khunti",
  },
  {
    id: 2,
    ...
    link: "https://indianexpress.com/article/india/ayushman-expanded-over-2-lakh-elderly-join-in-week-after-rollout-9663462/",
  },
  {
    id: 3,
    ...
    link: "https://www.bing.com/news/search?q=New+Education+Scholarship+Announced&eventans=1&eventland=0&eventrel=0&qpvt=New+Education+Scholarship+Announced&FORM=EWRE",
  },
  {
    id: 4,
    ...
    link: "https://iaspoint.com/rural-development-budget-allocations-in-india-2025-26/",
  },
];
            ...
            <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
              <div className="text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link
                    to="/scheme"
                    className="px-8 py-3 bg-green-600 text-white font-medium rounded-lg shadow-lg hover:bg-green-700 transition-all duration-300 flex items-center justify-center"
                  >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <span className="text-gray-600">stay updated for more news</span>
          </div>
        </div>
      </section>
