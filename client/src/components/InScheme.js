// InScheme.js (frontend component)
...
const InScheme = () => {
  ...
  useEffect(() => {
    ...
    const checkIfSaved = async () => {
      try {
        ...
        if (response.ok) {
          const savedSchemes = await response.json();
          const isSchemeSaved = savedSchemes.some(
            (scheme) => scheme._id === _id
          );
          if (isMounted) {
            setIsSaved(isSchemeSaved);
          }
        }
      } catch (error) {
  ...
  const formatCaste = (caste) => {
    ...
    if (caste.toLowerCase() === "ews")
      return "Economically Weaker Sections (EWS)";
  ...
  const handleSave = async () => {
    const token = localStorage.getItem("token");
    if (!token) {
      toast.info("Please login to save this scheme");
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-md -mt-16 md:-mt-24 mb-8 relative z-10">
          ...
          <div className="w-full h-64 md:h-80 overflow-hidden rounded-t-xl">
            <img
              src={
                schemeDetails?.schemeImageLink ||
                "https://via.placeholder.com/1200x600?text=Government+Scheme"
              }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 border-b border-gray-200">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-medium text-gray-900">
                  {formatState(schemeDetails?.state)}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-medium text-gray-900">
                  {formatCaste(schemeDetails?.caste)}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-medium text-gray-900">
                  {formatDate(schemeDetails?.applicationDeadline || "")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-gray-700 mb-4">
                  {schemeDetails?.benefits ||
                    "Multiple benefits are available under this scheme."}
                </p>
                <div className="mt-3">
                  <Link
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-gray-700 mb-4">
                  {schemeDetails?.shortDetail ||
                    "Please check the eligibility criteria to determine if you qualify for this scheme."}
                </p>
                <div className="mt-3">
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <p className="text-gray-700 mb-4">
                  The following documents are required when applying for this
                  scheme:
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {schemeDetails?.documentsRequired?.map((document, index) => (
                    ...
                    <div className="col-span-full text-gray-600 italic">
                      No specific documents listed. Please check the official
                      website for document requirements.
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">
                        Complete the application form on the official website or
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">
                        After submission, you can track the status of your
                        application using the reference number.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-gray-700">
                    Follow the link below to submit your application for this
                    scheme.
                  </p>
                </div>
                ...
                <div className="flex space-x-3">
                  ...
                  <button className="inline-flex items-center px-6 py-3 text-base font-medium text-green-700 bg-white border border-green-300 rounded-lg hover:bg-green-50 transition-colors">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-700">
                      <strong>Timing:</strong> 9:00 AM to 6:00 PM (Monday to
                      Saturday)
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-700">Government of India</p>
