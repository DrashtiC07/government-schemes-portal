...
export default function Navbar() {
  ...
  // ✅ read from localStorage INSIDE component
  ...
  const handleLogout = () => {
    ...
    dispatch({ type: "CLEAR" }); // if you’re using context state
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <img
              ...
              alt="Logo"
            />
            <span className="text-xl font-bold text-green-700">FindScheme</span>
          </Link>
