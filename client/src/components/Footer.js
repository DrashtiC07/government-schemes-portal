        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-green-400">FindScheme</span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
                  <span>Home</span>
                </Link>
              </li>
              <li>
                <Link to="/scheme" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
                  <span>Schemes</span>
                </Link>
              </li>
              <li>
                <Link to="/about" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
                  <span>About Us</span>
                </Link>
              </li>
              <li>
                <Link to="/contact" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
                  <span>Contact Us</span>
                </Link>
              </li>
              <li>
                <Link to="/privacy-policy" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
                  <span>Privacy Policy</span>
                </Link>
              </li>
              <li>
                <Link to="/terms-of-service" className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-300">
                  <ChevronRight size={16} className="mr-2" />
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@findscheme.gov.in</span>
              </li>
              <li className="flex items-center space-x-3">
                <Globe size={18} className="text-green-400 flex-shrink-0" />
                <span className="text-gray-400">www.findscheme.gov.in</span>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} FindScheme. All Rights Reserved.
            </p>
