  ...
  const contactCards = [
    {
      ...
      email: "support@findscheme.gov.in",
    ...
    },
    {
      ...
      email: "feedback@findscheme.gov.in",
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-green-100">contact@findscheme.gov.in</p>
                      <p className="text-green-100">support@findscheme.gov.in</p>
                    </div>
                  </div>
